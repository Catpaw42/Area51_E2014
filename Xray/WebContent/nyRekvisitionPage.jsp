					...
					<ul class="showInline">
						...
						<li>
							<div id="rekvirentData" class="hover">
								...
								<input type="text" id="rekvirent" name="rekvirent" placeholder="Rekvirent" readonly="readonly" value=<%= ((Bruger) request.getSession().getAttribute(LoginServlet.ACTIVE_USER)).getBrugerNavn() %>>
